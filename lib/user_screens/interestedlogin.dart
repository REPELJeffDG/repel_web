...
class InterestedLogin extends StatefulWidget {
  const InterestedLogin({super.key});

  @override
  State<InterestedLogin> createState() => _InterestedLoginState();
}

class _InterestedLoginState extends State<InterestedLogin> {
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                    '     Welcome back! Ready to dive in? Log in now to access your existing account and check your purchases progess',
